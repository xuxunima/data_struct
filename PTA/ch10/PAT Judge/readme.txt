...
Input Specification:
Each input file contains one test case. For each case, the first line contains 3 positive integers, N (¡Ü10
?4
?? ), the total number of users, K (¡Ü5), the total number of problems, and M (¡Ü10
?5
